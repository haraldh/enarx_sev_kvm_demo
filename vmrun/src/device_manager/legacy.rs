...
impl PortIODeviceManager {
    ...
    pub fn new() -> Result<Self> {
        ...
        let com_evt_1_3 = EventFd::new(EFD_NONBLOCK).map_err(Error::EventFd)?;
        let com_evt_2_4 = EventFd::new(EFD_NONBLOCK).map_err(Error::EventFd)?;
        let kbd_evt = EventFd::new(EFD_NONBLOCK).map_err(Error::EventFd)?;
