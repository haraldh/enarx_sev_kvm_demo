...
impl HostVirtAddr {
    ...
    pub fn new(addr: u64) -> HostVirtAddr {
    ...
    /// is returned.
    pub fn try_new(addr: u64) -> Result<HostVirtAddr, VirtAddrNotValid> {
        match addr.get_bits(47..64) {
            0 | 0x1ffff => Ok(HostVirtAddr(addr)), // address is canonical
            1 => Ok(HostVirtAddr::new_unchecked(addr)), // address needs sign extension
    ...
    pub const fn zero() -> HostVirtAddr {
        HostVirtAddr(0)
    }
